...
import { isCustomAgentFile } from '@codebuff/common/util/agent-file-utils'
...
export async function loadLocalAgents({
  ...
  try {
    ...
    for (const file of files) {
      ...
      // Skip TypeScript declaration files (.d.ts) generated by agent builder
      if (isCustomAgentFile(file)) {
