...
const BINARIES = {
  pty: {
    ...
    targets: [
      { platform: 'darwin', arch: 'x64', nodeAbi: '131' },
      { platform: 'darwin', arch: 'arm64', nodeAbi: '131' },
      { platform: 'win32', arch: 'x64', nodeAbi: '131' },
      { platform: 'linux', arch: 'x64', nodeAbi: '131' },
      { platform: 'linux', arch: 'arm64', nodeAbi: '131' },
    ],
